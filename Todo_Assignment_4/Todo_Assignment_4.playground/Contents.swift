...
//try! TodoApi.getTodo(id: "4d82aaf9-21c9-428c-0037-3caab6a327b3") { (completion: HandlerTodo) in
//    do {
//        let todo = try completion()
//
//        print(todo!)
...
print("delete a todo")
//try! TodoApi.deleteTodo(id: "4d82aaf9-21c9-428c-0037-3caab6a327b3") { (completion: HandlerVoid) in
//    do {
//        try completion()
//
//    } catch  {
